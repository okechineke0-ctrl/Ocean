              ...
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <a
                      href={COMPANY_INFO.phoneTel}
                      className="px-3 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-[11px] transition-colors inline-flex items-center gap-1.5 border border-slate-700"
                    >
