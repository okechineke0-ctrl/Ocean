...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    tagline: 'End-to-end custom software engineering, cloud architecture, and proactive 24/7 SLA systems management.',
    description: 'A unified enterprise service combining custom full-stack software development with dedicated round-the-clock infrastructure management. We architect, build, deploy, and maintain high-performance web applications, mobile platforms, enterprise backends, and cloud microservices with guaranteed 99.9% uptime and zero-downtime hotfixes.',
    keyBenefits: [
      'Full-Cycle Engineering: From concept architecture to modular production code',
      'Guaranteed 99.9% Production Uptime SLA & 24/7 telemetry monitoring',
      'Automated daily encrypted cloud snapshots with 1-click restore recovery',
      'Paystack, Flutterwave, and Stripe payment gateway integrations',
      'Strict OWASP security protocols, database query optimization, and memory load balancing',
      'Dedicated engineering on-call support with sub-2-hour emergency triage'
    ],
    deliverables: [
      'Production-grade modular codebase with full Git repository access',
      'Real-Time Telemetry & Uptime Monitoring Dashboard',
      'Architectural Blueprint, Database Schema & API documentation',
      'Automated Cloud Backup Verification and recovery logs',
      'Zero-downtime rolling security patching and ongoing SLA maintenance'
    ],
    technologies: ['TypeScript', 'React', 'Node.js', 'PostgreSQL', 'Docker', 'Ubuntu Server', 'Python', 'Redis', 'Nginx', 'AWS / DigitalOcean'],
    deliveryTime: '2 to 6 Weeks Dev + Dedicated Ongoing Operations',
    startingPriceNGN: 450000,
    startingPriceUSD: 360,
    iconName: 'Code',
    isPopular: true,
